  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 md:py-20 text-slate-300">
      ...
      <section className="space-y-8">
        ...
        <div className="bg-mint-900/20 p-6 rounded-lg border border-mint-500/30">
          <h2 className="text-xl font-semibold mb-3 text-mint-400">3. Immediate Deletion Guarantee</h2>
          ...
          <p className="leading-relaxed text-slate-300 mt-2 text-sm">
        ...
        <div>
          ...
          <div className="bg-slate-800/50 p-6 rounded-lg border border-slate-700">
            <p className="font-bold text-white">Engaging Enterprises Ltd</p>
            <p>Monomark House, 27 Old Gloucester Street</p>
            <p>London, England, WC1N 3AX</p>
            <p className="mt-2 text-sm italic text-slate-400">Company No: 14111995</p>
          </div>
        </div>
      </section>
    </div>
