...
export default function Pricing() {
  ...
  return (
    /* Background kept as gray-50 per request. Padding adjusted to match Home/Blog exactly */
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200 flex flex-col">
            ...
            <div className="bg-gray-100 text-gray-400 py-3 rounded-lg font-semibold cursor-not-allowed text-sm">
              Current Plan
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200 flex flex-col hover:shadow-md transition">
            ...
            <button 
              ...
              disabled={!!loading}
              className="w-full bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100 font-bold py-3 rounded-lg transition disabled:opacity-50 text-sm"
            >
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border-4 border-emerald-500 relative flex flex-col lg:scale-110 z-10">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200 flex flex-col hover:shadow-md transition">
            ...
            <button 
              ...
              disabled={!!loading}
              className="w-full bg-slate-900 hover:bg-black text-white font-bold py-3 rounded-lg transition disabled:opacity-50 text-sm active:scale-95"
            >
        ...
        <div className="mt-24 border-t border-gray-200 pt-10">
           <p className="text-gray-500">
            ...
            <a href="mailto:support@docneat.com" className="ml-2 text-emerald-600 font-semibold underline hover:text-emerald-700">
              Contact us
            </a>
          </p>
        </div>
